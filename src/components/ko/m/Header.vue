<template>
    <div>
        <header id="header">
            <h1><router-link to="/m/ko/"><img src="../../../assets/img/m/logo_white.png" alt=""></router-link></h1>
        ...
        <nav id="nav" class="modal">
            <header>
                <h1><router-link to="/m/ko/"><img src="../../../assets/img/m/logo_black.png" alt=""></router-link></h1>
