        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">티엠디랩-연세대 의대 공동연구, ‘의료기기 맞춤형 소재’ 국책과제 선정</h5>
                    <time>2020년 9월 15일</time>
                </div>
                <div class="modal-body">
                    <p>
                        <b>- 체온에 반응하는 첨단 형상기억고분자 원천기술로 ‘인체삽입형 의료기기’ 분야의 새 시대 열어</b>
                        <br><br>
                    ...
                    <img class="news-image mt-3" src="@/assets/img/promotion/img_news_12_ko.jpg">
                    <p>
                        [그림. 혈관 문합부 협착 방지 및 맥관 재생 용 시제품 작용원리] 인체에 삽입된 이후 체온에 의해 혈관 외벽을 감싸주는 형태로 복원되는 고분자 소재가 적용된다. 
                        <br><br>
                        <b>주식회사 티엠디랩</b><br>
